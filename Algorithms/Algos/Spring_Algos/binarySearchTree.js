  ...
  // ************************ FRIDAY ************************
     ...
     */
    toArrLevelorder(current = this.root, level = []) {

        if (!current) {
            return level
        }

        let leftRunner = current.left
        let rightRunner = current.right
        ...
        if (leftRunner) {
            level.push(leftRunner.data)
        }

        if (rightRunner) {
            level.push(rightRunner.data)
        }

        this.toArrLevelorder(current.left, level)
        this.toArrLevelorder(current.right, level)
